...
Canonical Prolog predicate schema for artifacts that cross skill boundaries in the orbital-shifting pipeline. One file per artifact. When a skill's local documentation disagrees with a file in this wiki, **the wiki wins** and the skill is out of date.
