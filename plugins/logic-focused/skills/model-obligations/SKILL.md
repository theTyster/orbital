...
The primary way to execute this skill is to spawn the `logic-focused:prolog-prover`
...
the KB schema mid-construction) spawn `logic-focused:agent-of-questions` instead —
...
`plugins/logic-focused/lean/Ontology/Prelude.lean`) and exposes:
