...
require Ontology from "<ONTOLOGY_ROOT — expand to absolute path of plugins/logic-focused/lean>"
```

`<ONTOLOGY_ROOT>` is the absolute path to `plugins/logic-focused/lean/` inside
