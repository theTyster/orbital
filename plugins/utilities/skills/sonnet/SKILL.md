...
Then run the user's ARGUMENTS as a prompt in a new Claude Sonnet session, prepending the gathered context so the new session has immediate environmental awareness:
